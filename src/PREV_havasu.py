...
class Havasu:
    ...
    cursor, connection = Database.startConnection()
    ...
    def __del__(self):
        Database.endConnection(self) # end connection
    # destructor
    ...
    def checkPermissionRecords(self, id):
    ...
    def recordAndroidPermissions(self, trojan, permissions):
        updatedColumns = 0
        unknownPermissions = list()
        standardPermissionList = Havasu.getStandardAndroidPermissionList(self)
